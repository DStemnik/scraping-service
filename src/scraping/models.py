...
def default_url():
    return {'hh': '', 'habr': '', 'superjob': ''}


class City(models.Model):
    name = models.CharField(max_length=50, verbose_name='Название города', unique=True)
    slug = models.CharField(max_length=50, blank=True, verbose_name='ЧПУ', unique=True)
...
class Vacancy(models.Model):
    ...
    money = models.CharField(max_length=250, verbose_name='Зарплата', blank=True)
